...
btnRoll.addEventListener('click', function() {
    if (playing) {
        ...
        if (diceNum !== 1) {
            ...
            document.getElementById(`current--${activePlayer}` // Creating dynamic variables
...
btnNew.addEventListener('click', init); // INSTEAD OF WRITING ALL THE CODE BELOW INSIDE THE BUTTON, IT IS MOVED AS A SEPARATE FUNCTION TO WORK AT THE PAGE LOAD AND AFTER THE GAME IS RESET
 // if (player0El.classList.contains('player--winner')) {
 //   player0El.classList.remove('player--winner');
 //   player0El.classList.add('player--active');
 // } else if (player1El.classList.contains('player--winner')) {
